		...
		<div>
			...
			<section className="max-w-5xl mx-auto mb-20">
				<div className="grid md:grid-cols-3 gap-8 text-center">
					<div className="p-8 bg-[#0D7377]/5 rounded-lg">
						<div className="text-5xl font-bold text-[#0D7377] mb-2">
							500K+
						</div>
			...
			<section className="max-w-5xl mx-auto mb-20">
				...
				<div className="grid md:grid-cols-2 gap-8">
					<div className="p-8 border rounded-lg hover:border-[#0D7377] transition-colors">
			...
			<section className="max-w-2xl mx-auto">
				<div className="bg-[#0D7377]/5 rounded-lg p-8 md:p-12">
					...
					<form className="space-y-6">
						<div className="grid md:grid-cols-2 gap-6">
							<div>
								...
								<input
									type="text"
									id="name"
									className="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0D7377]"
						...
						<button
							type="submit"
							className="w-full px-8 py-4 bg-[#0D7377] text-white rounded-lg hover:bg-[#0A5F62] transition-colors font-medium text-lg"
						>
							Enviar Solicitação
						</button>
					</form>
