		...
		<div>
			...
			<div className="flex items-center gap-3 mb-12 pb-8 border-b">
				...
				<Button
					variant="outline"
					size="icon"
					className="rounded-full bg-transparent hover:bg-primary/10 hover:text-primary hover:border-primary"
				>
			...
			<article className="prose prose-lg max-w-none">
				...
				<blockquote className="border-l-4 border-primary pl-6 my-12 italic text-xl">
				...
				<div className="relative aspect-video w-full overflow-hidden rounded-lg my-12">
					<Image
						src="/images/colorful-african-ankara-fabric-patterns-on-fashion.jpg"
			...
			<div className="flex flex-wrap items-center gap-2 mt-12 pt-8 border-t">
				...
				<Link
					...
					className="px-3 py-1 bg-secondary text-secondary-foreground text-sm rounded-full hover:bg-primary/10 hover:text-primary transition-colors"
				>
					Moda Africana
				</Link>
				<Link
			...
			<div className="mt-12 p-8 bg-secondary/30 rounded-lg">
				<div className="flex items-start gap-4">
					<div className="w-20 h-20 rounded-full bg-primary/20 shrink-0" />
					<div>
