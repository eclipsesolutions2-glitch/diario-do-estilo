...
export default function AboutUs() {
	return (
		<div>
			...
			<section className="max-w-3xl mx-auto text-center bg-primary/5 rounded-lg p-12">
				...
				<a
					href="/equipe"
					className="inline-block px-8 py-3 bg-primary text-white rounded-lg hover:bg-[#0A5F62] transition-colors font-medium"
				>
					Ver Equipe
				</a>
			</section>
