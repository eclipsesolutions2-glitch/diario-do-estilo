			...
			>
				<div className="py-4 px-6 flex items-center justify-between">
					...
					<button
						...
						className="text-xs font-bold text-gray-600 hover:text-primary disabled:text-gray-400 disabled:cursor-not-allowed"
					>
						MARCAR TODAS COMO VISTAS
					</button>
				</div>
				<div>
					<div className="px-5 py-2 text-sm text-gray-400 dark:text-gray-400 bg-gray-100 dark:bg-gray-800">
						Recentes
					</div>
					<ScrollArea className="max-h-[385px] overflow-y-auto">
						{notifications ? (
							notifications.length > 0 ? (
								...
								<div className="min-h-60 p-4 text-center select-none text-gray-500 dark:text-gray-700 flex flex-col items-center justify-center">
