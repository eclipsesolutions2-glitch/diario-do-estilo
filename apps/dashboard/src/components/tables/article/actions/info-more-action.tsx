    ...
    <Dialog>
      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          {/* Conteúdo (limitado) */}
          <Field label="Conteúdo" value={data.content} multiline clamp />

          {/* Autor */}
          <Field label="Autor" value={`${data.author?.name}`} />

          {/* Editor */}
          <Field label="Editor" value={`${data.published_by?.name}`} />

          {/* Status */}
          <Field label="Publicado" value={data.is_published ? "Sim" : "Não"} />

          {/* Destaque */}
          <Field label="Destaque" value={data.is_featured ? "Sim" : "Não"} />
          ...
          <div className="flex flex-col gap-2 col-span-2">
            <span className="font-medium text-neutral-700">Imagem de Capa</span>
