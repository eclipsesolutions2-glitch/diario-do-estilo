    ...
    <div className="w-full">
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription className="text-sm text-muted-foreground">
                Preencha os detalhes abaixo para adicionar uma nova categoria ao
                sistema.
              </DialogDescription>
            </DialogHeader>
            <CreateCategoryForm onFinishSubmit={() => setShowModal(false)} />
          </DialogContent>
        </Dialog>
      </div>
      ...
      <div className="flex items-center justify-between py-4 text-sm text-muted-foreground">
        <span>
          ...
          {table.getFilteredRowModel().rows.length} categorias exibidos
        </span>
