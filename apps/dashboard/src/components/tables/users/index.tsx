          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription className="text-sm text-muted-foreground">
                Preencha os detalhes abaixo para adicionar uma nova usuário ao
                sistema.
              </DialogDescription>
            </DialogHeader>
            <CreateUserForm onFinishSubmit={() => setShowModal(false)} />
          </DialogContent>
        </Dialog>
      </div>
              ...
              <TableRow>
                ...
                >
                  <div className="flex flex-col items-center gap-2 text-muted-foreground">
                    <SearchX size={32} />
                    <span>Nenhum usuário encontrada</span>
                  </div>
                </TableCell>
              </TableRow>
            )}
