...
import { OverviewCard, OverviewCardContent, OverviewCardIcon } from "@/components/overview/overview-card";
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p>Gerencie seu conteúdo de moda africana e mantenha sua plataforma atualizada</p>
            </div>
