...
export async function findManyUserAction(params?: FindManyUserActionParams): Promise<ApiResponse<FindManyUserActionResponse>> {
    ...
    try {
        ...
        const response = await fetch(`${NEXT_PUBLIC_API_URL}/api/v1/auth/users?${query}`, {
            method: "GET",
            headers: {
