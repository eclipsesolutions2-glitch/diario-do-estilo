    ...
    <div>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            <h2 className="text-3xl font-serif mb-4">1. O que são Cookies?</h2>
          ...
          <section>
            <h2 className="text-3xl font-serif mb-4">2. Como Usamos Cookies</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              O Diário Do Estilo usa cookies para melhorar sua experiência no
              site. Usamos cookies para:
            </p>
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="p-6 bg-primary/5 rounded-lg">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Estes cookies são necessários para o funcionamento do site e
                  não podem ser desativados. Eles geralmente são definidos
                  apenas em resposta a ações suas, como definir suas
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Além de nossos próprios cookies, também usamos vários serviços de
              terceiros que podem definir cookies em seu dispositivo:
            </p>
            <ul className="space-y-2 text-muted-foreground">
              <li>• Google Analytics - para análise de tráfego do site</li>
              <li>
                • Redes sociais (Facebook, Instagram, Twitter) - para
                compartilhamento de conteúdo
              </li>
              <li>• Serviços de publicidade - para anúncios direcionados</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Você pode controlar e/ou excluir cookies como desejar. Você pode
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              Note que, se você desativar cookies, algumas funcionalidades do
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Podemos atualizar nossa Política de Cookies periodicamente para
              refletir mudanças em nossas práticas ou por outras razões
              operacionais, legais ou regulatórias. Recomendamos que você revise
          ...
          <section>
            ...
            <div className="mt-4 p-6 bg-primary/5 rounded-lg">
              <p className="text-muted-foreground">
                <strong>Email:</strong> privacidade@diariodoestilo.com
                <br />
