    ...
    <div>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            <h2 className="text-3xl font-serif mb-4">1. Introdução</h2>
            <p className="text-muted-foreground leading-relaxed">
              O Diário Do Estilo ("nós", "nosso" ou "nos") está comprometido em
          ...
          <section>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li>
                ...
                e outras informações que você nos fornece voluntariamente.
              </li>
              <li>
                <strong>Dados de Uso:</strong> Informações sobre como você
                acessa e usa nosso site, incluindo páginas visitadas e tempo
                gasto.
              </li>
              <li>
                <strong>Cookies e Tecnologias Similares:</strong> Usamos cookies
          ...
          <section>
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li>• Comunicar com você, diretamente ou através de parceiros</li>
              <li>
                • Enviar newsletters e atualizações (com seu consentimento)
              </li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              para terceiros sem seu consentimento, exceto quando necessário
              para fornecer nossos serviços ou quando exigido por lei.
            </p>
          </section>

          <section>
            <h2 className="text-3xl font-serif mb-4">5. Segurança dos Dados</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-3xl font-serif mb-4">6. Seus Direitos</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
