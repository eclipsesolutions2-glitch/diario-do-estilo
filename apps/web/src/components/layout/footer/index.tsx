    ...
    <footer className="border-t border-border bg-muted/30 mt-24">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed max-w-md mb-6">
              Falamos de moda global e crítica social, colocamos em evidência a
              moda africana e a cultura local. Arte, cultura geral e
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <p>© 2025 Diário Do Estilo. Todos os direitos reservados.</p>
